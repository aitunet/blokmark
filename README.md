...
- **Block styles** for cards, panels and images; a design-token layer (`--tnt-*`) that Blokino reads for its effects.
- **Translations**: neutral Spanish for es_ES and the common Latin American locales.

## Requirements

WordPress 6.6 or newer, PHP 7.4 or newer. Optional: [Blokino](https://github.com/aitunet/blokino) for effects and extra blocks.
