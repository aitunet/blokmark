...
<section class="wp-block-group alignfull ts-section ts-hero" style="padding-top:var(--wp--preset--spacing--9);padding-bottom:var(--wp--preset--spacing--9)">
	...
	<div class="wp-block-group alignwide ts-hero__grid">
		...
		<div class="wp-block-group ts-hero__copy">
			...
			<p class="ts-kicker"><?php esc_html_e( 'Design · Build · Launch', 'blokmark' ); ?></p>
			<!-- /wp:paragraph -->

			<!-- wp:heading {"level":1,"tfAnimation":"text-stagger","tfStagger":60,"tfAnimEasing":"expo"} -->
			<h1 class="wp-block-heading"><?php echo wp_kses_post( __( 'Build the site you <mark>actually</mark> want.', 'blokmark' ) ); ?></h1>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"className":"ts-lede","tfAnimation":"fade-up","tfAnimDelay":150,"tfAnimEasing":"expo"} -->
			<p class="ts-lede"><?php esc_html_e( 'Northline is a small studio for brands that have outgrown their first website. Strategy, design and code — from one team, without the runaround.', 'blokmark' ); ?></p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-buttons ts-hero__actions">
				...
				<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="#services"><?php esc_html_e( 'See what we do →', 'blokmark' ); ?></a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
		...
		<div class="wp-block-group ts-hero__stage">
			...
			<figure class="wp-block-image size-full ts-hero__photo"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/img/hero.webp' ) ); ?>" alt="<?php esc_attr_e( 'A designer and a developer reviewing a website layout on a laptop', 'blokmark' ); ?>"/></figure>
			<!-- /wp:image -->
			...
			<div class="wp-block-group is-style-ts-card ts-hero__card" style="padding-top:var(--wp--preset--spacing--4);padding-right:var(--wp--preset--spacing--4);padding-bottom:var(--wp--preset--spacing--4);padding-left:var(--wp--preset--spacing--4)">
				...
				<div class="wp-block-group">
					...
					<p class="ts-hero__quote has-sm-font-size"><?php esc_html_e( '“Launched in two weeks, and it still feels like us.”', 'blokmark' ); ?></p>
					<!-- /wp:paragraph -->
					<!-- wp:paragraph {"className":"ts-hero__who","fontSize":"xs"} -->
					<p class="ts-hero__who has-xs-font-size"><?php esc_html_e( 'Ana Ruiz — founder, Marlow Bakery', 'blokmark' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
