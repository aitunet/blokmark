 ...
 */
?>
<!-- wp:group {"tagName":"section","align":"full","className":"ts-section ts-proof","style":{"spacing":{"padding":{"top":"var:preset|spacing|6","bottom":"var:preset|spacing|6"}}},"layout":{"type":"constrained"}} -->
<section class="wp-block-group alignfull ts-section ts-proof" style="padding-top:var(--wp--preset--spacing--6);padding-bottom:var(--wp--preset--spacing--6)">
	<!-- wp:group {"align":"wide","className":"ts-proof__row","tfAnimation":"fade-up","tfStagger":90,"tfAnimEasing":"expo","layout":{"type":"flex","justifyContent":"space-between","flexWrap":"wrap"}} -->
	<div class="wp-block-group alignwide ts-proof__row">
